...
需要 Node.js 22 或更新版本、用于管理 profile 插件的 pnpm，以及已配置模型的 DSH。DSH 的安装参见[官方仓库说明](https://github.com/deepseek-ai/deepseek-harness#quick-start)，Web 界面和首次配置参见[官方快速开始](https://deepseek-harness.github.io/deepseek-harness/guide/quickstart)。

本版本使用 DSH `0.1.2-rc.1` 的官方已安装包核对接口并运行契约测试；完整核验范围见[标准化记录](docs/standardization.md)。
...
- [标准化依据与提交演进](docs/standardization.md)
- [变更记录](CHANGELOG.md)
- [贡献指南](CONTRIBUTING.md)

历史设计保留在 [PLAN.md](PLAN.md) 与 [M6 面板规划](docs/M6-web-panel.md)，其中的旧版接口结论不作为当前安装说明。
